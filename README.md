...
| Name | Links | Description | Quasar |
| --- | --- | --- | --- |
| RaspberryPi-GPIO-Manager-Frontend | [github](https://github.com/jk-powered-de/RaspberryPi-GPIO-Manager-Frontend) | Opensource RaspberryPi GPIO Manager Frontend based on Vue.js/Quasar for RaspberryPi GPIO Manager Backend | v2.2.3 |
