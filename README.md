...
| Name | Links | Description | Quasar |
| --- | --- | --- | --- |
| Exorcism | [github](https://github.com/siamx/exorcism) | Desktop wallpaper manager | v1.0.0-rc.6 |
| SA Email Builder | [website](https://app.emailbuilder.top/) | Email template builder responsive v5 | v1.0.0-rc.2 |
| Cashier | [app](http://cashier.alensiljak.ml/), [source](https://gitlab.com/alensiljak/cashier) | An app for creating ledger/hledger transactions | v1.0.0-beta.24 |
